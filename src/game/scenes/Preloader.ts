    ...
    preload() {
        ...
        PLAYABLE_CHARACTERS.forEach((char) => {
            this.load.spritesheet(
                char.key,
                `characters/${char.key}/${char.key}.png`,
                {
            ...
            this.load.image(
                `${char.key}-avatar`,
                `characters/${char.key}/avatar.png`,
            );
        });
        ...
        this.load.image(
            "grass-tileset",
            `tilesets/grass.png${this.ASSET_VERSION}`,
        );

        // Water tileset as spritesheet for animation (4 frames)
        this.load.spritesheet(
            "water-tileset",
            `tilesets/water.png${this.ASSET_VERSION}`,
            {
                frameWidth: 16,
                frameHeight: 16,
            },
        ...
        this.load.image(
            "tilled-dirt-tileset",
            `tilesets/tilled-dirt.png${this.ASSET_VERSION}`,
        );
        this.load.image(
            "hills-tileset",
            `tilesets/hills.png${this.ASSET_VERSION}`,
        );
        // Square tileset (176x112, 11 cols x 7 rows of 16x16 tiles)
        this.load.spritesheet(
            "square-tileset",
            `tilesets/square.png${this.ASSET_VERSION}`,
            {
                frameWidth: 16,
                frameHeight: 16,
            },
        ...
        this.load.spritesheet(
            "classroom-tileset",
            `tilesets/class-room.png${this.ASSET_VERSION}`,
            {
                frameWidth: 16,
                frameHeight: 16,
            },
        ...
        this.load.spritesheet(
            "fountain",
            `objects/square/fountain.png${this.ASSET_VERSION}`,
            {
                frameWidth: 142.6,
                frameHeight: 235,
            },
        ...
        this.load.spritesheet(
            "merlin1",
            `objects/merlin/merline1.png${this.ASSET_VERSION}`,
            {
                frameWidth: 539,
                frameHeight: 467,
            },
        ...
        this.load.spritesheet(
            "merlin2",
            `objects/merlin/merline2.png${this.ASSET_VERSION}`,
            {
                frameWidth: 510,
                frameHeight: 493,
            },
        ...
        this.load.image(
            "square-chair",
            `objects/square/chair.png${this.ASSET_VERSION}`,
        );
        this.load.image(
            "square-lamp",
            `objects/square/lamp.png${this.ASSET_VERSION}`,
        );
        this.load.image(
            "square-tree",
            `objects/square/tree.png${this.ASSET_VERSION}`,
        );
        ...
        for (let i = 1; i <= 12; i++) {
            this.load.image(
                `house-${i}`,
                `objects/house/house-${i}.png${this.ASSET_VERSION}`,
            );
        }
        ...
        this.load.image(
            "tree-seed",
            "objects/plant/social_plant/Social_Seed.png",
        );
        this.load.image(
            "tree-plant-1",
            "objects/plant/social_plant/Social_plant_1.png",
        );
        this.load.image(
            "tree-plant-2",
            "objects/plant/social_plant/Social_plant_2.png",
        );
        this.load.image(
            "tree-plant-3",
            "objects/plant/social_plant/Social_plant_3.png",
        );
        this.load.image(
            "tree-plant-4",
            "objects/plant/social_plant/Social_plant_4.png",
        );
        this.load.image(
            "tree-plant-death",
            "objects/plant/social_plant/Social_plant_death.png",
        );
        this.load.image(
            "tree-fruit",
            "objects/plant/social_plant/social-fruit.png",
        );
        ...
        this.load.image(
            "algae-plant-death",
            "objects/plant/algae/algae_death.png",
        );
        ...
        this.load.image(
            "mushroom-seed",
            "objects/plant/mushroom/mush_seed.png",
        );
        // Replaced spritesheet with individual images per user request
        this.load.image(
            "mushroom-plant-1",
            "objects/plant/mushroom/mush_plant_1.png",
        );
        this.load.image(
            "mushroom-plant-2",
            "objects/plant/mushroom/mush_plant_2.png",
        );
        this.load.image(
            "mushroom-plant-3",
            "objects/plant/mushroom/mush_plant_3.png",
        );
        this.load.image(
            "mushroom-plant-death",
            "objects/plant/mushroom/mush_plant_death.png",
        );
        this.load.image(
            "mushroom-fruit",
            "objects/plant/mushroom/mush-fruit.png",
        );

        // Factory (4 frames: 1-2 idle, 3-4 working)
        this.load.image(
            "factory-1",
            `objects/factory/factory_1.png${this.ASSET_VERSION}`,
        );
        this.load.image(
            "factory-2",
            `objects/factory/factory_2.png${this.ASSET_VERSION}`,
        );
        this.load.image(
            "factory-3",
            `objects/factory/factory_3.png${this.ASSET_VERSION}`,
        );
        this.load.image(
            "factory-4",
            `objects/factory/factory_4.png${this.ASSET_VERSION}`,
        );

        // Warehouse spritesheet (2 frames: 0=closed, 1=open)
        this.load.spritesheet(
            "warehouse",
            "objects/ware-house/ware-house.png",
            {
                frameWidth: 120,
                frameHeight: 135,
            },
        ...
        this.load.image(
            "classroom-table",
            `objects/class-room/table.png${this.ASSET_VERSION}`,
        );
        this.load.image(
            "classroom-chair",
            `objects/class-room/chair.png${this.ASSET_VERSION}`,
        );
        this.load.image(
            "classroom-board",
            `objects/class-room/board.png${this.ASSET_VERSION}`,
        );
        this.load.spritesheet(
            "teacher1",
            `objects/class-room/teacher1.png${this.ASSET_VERSION}`,
            { frameWidth: 125, frameHeight: 125 },
        );
        this.load.spritesheet(
            "teacher2",
            `objects/class-room/teacher2.png${this.ASSET_VERSION}`,
            { frameWidth: 125, frameHeight: 125 },
        );
        ...
        this.load.spritesheet(
            "shop",
            `objects/shop/shop.png${this.ASSET_VERSION}`,
            {
                frameWidth: 159,
                frameHeight: 119,
            },
        ...
        this.load.spritesheet(
            "well",
            `objects/well/well.png${this.ASSET_VERSION}`,
            {
                frameWidth: 177,
                frameHeight: 177,
            },
        ...
        this.load.spritesheet(
            "tutor",
            `objects/well/tutor.png${this.ASSET_VERSION}`,
            {
                frameWidth: 45,
                frameHeight: 55,
            },
        ...
        this.load.spritesheet(
            "station",
            `objects/station/station.png${this.ASSET_VERSION}`,
            {
                frameWidth: 121,
                frameHeight: 92,
            },
        ...
        this.load.spritesheet("soccer-player", "pet/soccer-player/soccer.png", {
            frameWidth: 125,
            frameHeight: 125,
        });
